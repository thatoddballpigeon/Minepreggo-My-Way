...
public abstract class EnderImpregnationPotionBrewingRecipe implements IBrewingRecipe {
	...
	private EnderImpregnationPotionBrewingRecipe() {}
	...
	public static class Amplifier0 extends EnderImpregnationPotionBrewingRecipe {		
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), PregnancySystemHelper.RANDOM_SOURCE.nextBoolean() ? MinepreggoModPotions.ENDER_IMPREGNATION_0.get() : MinepreggoModPotions.HUMANOID_ENDER_IMPREGNATION_0.get());
	...
	public static class Amplifier1 extends EnderImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), PregnancySystemHelper.RANDOM_SOURCE.nextBoolean() ? MinepreggoModPotions.ENDER_IMPREGNATION_1.get() : MinepreggoModPotions.HUMANOID_ENDER_IMPREGNATION_1.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier2 extends EnderImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), PregnancySystemHelper.RANDOM_SOURCE.nextBoolean() ? MinepreggoModPotions.ENDER_IMPREGNATION_2.get() : MinepreggoModPotions.HUMANOID_ENDER_IMPREGNATION_2.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier3 extends EnderImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), PregnancySystemHelper.RANDOM_SOURCE.nextBoolean() ? MinepreggoModPotions.ENDER_IMPREGNATION_3.get() : MinepreggoModPotions.HUMANOID_ENDER_IMPREGNATION_3.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;
	...
	public static class Amplifier4 extends EnderImpregnationPotionBrewingRecipe {
		...
		public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
			if (isInput(input) && isIngredient(ingredient)) {
				var result = PotionUtils.setPotion(new ItemStack(input.getItem()), PregnancySystemHelper.RANDOM_SOURCE.nextBoolean() ? MinepreggoModPotions.ENDER_IMPREGNATION_4.get() : MinepreggoModPotions.HUMANOID_ENDER_IMPREGNATION_4.get());
				CumSpecimenTubeItem.tryTransferOwner(input, result);
				return result;
			}
			return ItemStack.EMPTY;

...
public class MetabolismControlPotionBrewingRecipe implements IBrewingRecipe {
	@Override
	...
	public boolean isIngredient(ItemStack ingredient) {
		return ingredient.is(Items.CRIMSON_FUNGUS) || ingredient.is(Items.WARPED_FUNGUS);
	}

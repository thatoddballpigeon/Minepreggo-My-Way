...
public class FertilityPotionBrewingRecipe implements IBrewingRecipe {
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionUtils.setPotion(new ItemStack(input.getItem()), MinepreggoModPotions.FERTILITY.get());
		}

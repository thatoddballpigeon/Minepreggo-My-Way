...
public class BellyShieldP6Model extends AbstractBellyShield<LivingEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(MinepreggoHelper.fromNamespaceAndPath(MinepreggoMod.MODID, "belly_shield_p6_model"), "main");

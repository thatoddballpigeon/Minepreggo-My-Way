...
public class MaternityChestPlateP4Model extends AbstractFemaleChestPlateModel<LivingEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(MinepreggoHelper.fromNamespaceAndPath(MinepreggoMod.MODID, "maternity_chestplate_p4_model"), "main");

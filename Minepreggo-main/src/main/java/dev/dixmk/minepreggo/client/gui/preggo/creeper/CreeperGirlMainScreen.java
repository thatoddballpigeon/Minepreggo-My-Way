...
import dev.dixmk.minepreggo.world.inventory.preggo.creeper.HumanoidCreeperGirlMainMenu;
...
@OnlyIn(Dist.CLIENT)
public class CreeperGirlMainScreen extends AbstractHumanoidCreeperGirlMainScreen<TamableHumanoidCreeperGirl, HumanoidCreeperGirlMainMenu> {

	protected final boolean pregnant;
	
	public CreeperGirlMainScreen(HumanoidCreeperGirlMainMenu container, Inventory inventory, Component text) {
